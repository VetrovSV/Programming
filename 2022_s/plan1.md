...
**заполнение списка случайнми числами**
```python
...
# объявление функций
def calc_hypotenuse(k1: float, k2:float):
    """вычисляет гипотенузу по катедам a и b"""
...
Но набор чисел удобнее читать когда он записан в строку, особенно если там много элементов. Чтобы print не переходил на новую строку добавим в него параметр end = " ". Т.е. после вывода данных print вместо перхода на новую строку выведет пробел. 
