...
Пример записи 
```python
# открываем файл 'data.txt' как текстовый (t) для чтения (r),
...
### Задание
Добавьте к программам по задачам из первого раздела задачника запись отчёта о выполнении: выводите исходные данные и вычисленные значений в файл.
Открывайте файл в режиме дополнения. 

В последующих задачах тоже записывайте отчёт.


## Занятие 5. Списки. Продолжение. Библиотека numpy
