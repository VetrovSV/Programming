...
- Создайте конспект-шпаргалку с набором типичных операций в Python
    ...
    4. Условный оператор
    5. Циклический оператор while и for
    5. Нахождение суммы известного числа слагаемых
    6. Объявление списка из чисел; определение длины списка
    7. Вывод списка на экран
    8. Заполнение списка случайными числами, с клавиатуры, по формуле
    9. Изменение элементов списка по формуле
    10. Поиск числа в списке
    11. Объявление функции без возврата и с возвратом значения; вызов функции (укажите формальные и фактические параметры)
    12. Дополните конспект материалами на свой выбор
