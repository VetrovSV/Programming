...
Создавайте функции для записи списка в текстовый файл. Используйте CSV формат.

1. Создайте набор из случайных чисел без повторов $x_1, x_2, ..., x_n$. Интервал $(a,b)$ и количество случайных чисел задаются пользователем. $n<<b−a$
